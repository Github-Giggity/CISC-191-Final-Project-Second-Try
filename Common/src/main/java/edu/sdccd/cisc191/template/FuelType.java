...
import java.io.*;
//v.7.5.0 added I/O Streams that read specific fuel type of the vehicle from a defined list
    ...
    public static void main(String [] args){
        try{
            BufferedReader br=new BufferedReader(
                    new FileReader("C:\\Users\\Dell\\Desktop\\CISC 191 IO Streams\\FuelType.txt"));
            String s;
